...
/*==================== Denne skroller Teksten inn altså overtekst ====================*/
ScrollReveal({
    // reset: true,
    distance: '80px',
    duration: 2000,
...
ScrollReveal().reveal('.home-img, .skole-container, .portfolio-box, .contact form', { origin: 'bottom' });
ScrollReveal().reveal('.home-content h1,.about-img .gaming-img, ', { origin: 'left' });
